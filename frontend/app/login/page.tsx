...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-background overflow-hidden flex items-center justify-center font-sans p-4">
      ...
      >
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-extrabold font-outfit text-foreground mb-2 tracking-tight">Project Chronos</h1>
        ...
        <div className="glass-card p-8 rounded-2xl border border-white/5 shadow-2xl relative">
          ...
          <form onSubmit={handleStandardSubmit} className="space-y-5">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 rounded-xl text-sm glass-input text-strong"
                  disabled={loading}
                />
              </div>
            </div>
            ...
            <div>
              <label className="block text-xs font-semibold text-muted uppercase tracking-wider mb-2">Secure Password</label>
              <div className="relative">
                <span className="absolute inset-y-0 left-0 pl-3.5 flex items-center text-faint">
            ...
            <div className="flex items-center justify-between text-xs">
              <label className="flex items-center gap-2 cursor-pointer text-muted hover:text-strong">
                <input type="checkbox" className="rounded bg-surface border-edge-strong text-blue-500 focus:ring-blue-500/30" />
          ...
          <div className="relative my-6 text-center">
            ...
            <span className="relative z-10 px-3 bg-surface text-faint text-[10px] uppercase font-bold tracking-widest">or evaluation bypass</span>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 rounded-xl border border-edge bg-surface/40 hover:bg-surface-2 text-strong hover:text-foreground font-semibold text-sm transition-all flex items-center justify-center gap-2.5 cursor-pointer group"
          >
