...
export default function RootError({ error, reset }: ErrorProps) {
  ...
  return (
    <div className="flex h-screen w-full items-center justify-center bg-[#05070B] p-4 text-center font-sans">
      <div className="glass-card p-8 rounded-2xl border border-red-500/10 bg-red-500/5 max-w-md w-full space-y-6">
        ...
        <div className="space-y-2">
          <h2 className="text-xl font-bold text-white tracking-tight">Timeline Index Error</h2>
          <p className="text-xs text-slate-400 leading-relaxed">
            An anomaly was detected while calculating node projections. The runtime logs report:
          </p>
          <div className="p-3 rounded-lg bg-slate-950/60 border border-slate-900 text-left font-mono text-[10px] text-red-400 overflow-x-auto select-text">
